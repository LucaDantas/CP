...
int main() {
	...
	while(t--) {
		...
		dec(i,n-1,1) {
			// if(par) a[0] = (char)(1-(a[0]-'0') + '0');
			if(a[0] == b[i]) ans.pb(1),	a[0] = (char)(1-(a[0]-'0') + '0');

			// for slow version use reverse
			ans.pb(i+1);
			reverse(a.begin(), a.begin()+i+1);
			rep(j,0,i+1) a[j] = (char)(1-(a[j]-'0') + '0');
		}

		// if(par) a[0] = (char)(1-(a[0]-'0') + '0');
		if(a[0] != b[0]) ans.pb(1), a[0] = (char)(1-(a[0]-'0') + '0');
